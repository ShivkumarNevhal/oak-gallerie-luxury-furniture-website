...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer id="stores">
        <div className="footer-top"><a className="brand" href="#top">OAK <span>GALLERIE</span></a><p>Furniture for a life well lived.</p></div>
        <div className="footer-links">
          <div><p className="footer-label">Visit</p><a href="#stores">Copenhagen</a><a href="#stores">London</a><a href="#stores">New York</a></div>
          <div><p className="footer-label">Connect</p><a href="mailto:studio@oakgallerie.com">studio@oakgallerie.com</a><a href="#journal">Instagram</a><a href="#journal">Pinterest</a></div>
          ...
          <p className="newsletter">A considered note from our world.<br /><a href="mailto:studio@oakgallerie.com">Subscribe <b>↗</b></a></p>
        </div>
